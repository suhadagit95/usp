<div class="right_col" role="main">
	...
	<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">Laporan Daftar Pinjaman</h5>
						</div>
						<!-- Breadcrumb -->
					...
					<div class="table-responsive">
                        <table id="example" class="table table-hover display  pb-30" >
                            ...
                            <tr>
								...
								<th style="center;">Usulan Pinjaman</th>
								<th style=" center;">Realisasi</th>
								<th style=" center;">No Rek. Bank</th>
                                <th style="center;">Masa Pinjaman</th>
								<th style=" center;">Jenis Usaha</th>
								<th style=" center;">Agunan</th>
								<th style=" center;">NO HP</th>
								<th style=" center;">Satatus Pinjaman</th>
								<th style=" center;">Pesan</th>
                            ...
                            foreach ($ambil_data->result() as $r) {
                                ...
                                <th style="center;"><?php echo rupiah($r->jumlah_pinjaman); ?></th>
                              <th style="center;"><?php echo rupiah($r->usulan_disetujui); ?></th>
							  <th ><?php echo $r->no_rek_bank; ?></th>
                              <th style=" center;"><?php echo $r->jangka_waktu; ?> Bulan</th>
							  <th style=" center;"><?php echo $r->nama_usaha; ?></th>
							  <th style=" center;"><?php echo $r->jenis_agunan; ?></th>
                                <th ><?php echo $r->no_hp; ?></th>
								<th ><?php if ($r->pinjaman_disetujui == "Y"){ ?> Pinjaman Disetujui <?php } else if ($r->pinjaman_disetujui == "N"){ ?>
								Pinjaman Tidak Disetujui<?php }?></th>
								<th ><?php echo $r->pesan; ?></th>
