...
<div class="modal-footer">
    ...
    <a class="btn btn-warning btn-ok" href="<?php echo base_url();?>tu/edit_agunan/<?php echo hilang_karakter(base64_encode($r->id_pemanfaat));?>/<?php echo hilang_karakter(base64_encode($r->id_agunan));?>">Edit Agunan</a>
    <a class="btn btn-success btn-ok" href="<?php echo base_url();?>tu/edit_pinjaman/<?php echo hilang_karakter(base64_encode($r->id_pemanfaat));?>/<?php echo hilang_karakter(base64_encode($r->id_pinjaman));?>">Edit Pinjaman</a>
</div>