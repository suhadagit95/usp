<div class="right_col" role="main">
	...
	<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">Laporan Daftar Usulan</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li class="active"><span>Data Usulan</span></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
					...
					<div class="table-responsive">
                        <table id="example" class="table table-hover display  pb-30" >
                            ...
                            <tr>
								...
								<th style=" center;">Rekomendasi</th>
								<th style=" center;">Proses dokumen</th>
                            ...
                            foreach ($ambil_data->result() as $r) {
							  ...
							  <th style=" center;"><?php echo $r->jenis_agunan; ?></th>
								...
								<th ><?php echo $r->status_pinjaman; ?></th>
								<th >Proses Dokumen Belum Selesai</th>
