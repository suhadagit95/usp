				...
				<div class="table-responsive">
                    <table id="datable_1" class="table table-striped table-bordered">
                        ...
                        <tr>
							...
							<th style="width:18%; text-align: center;">Tools</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle; text-align: center;">
                                <button class="btn btn-xs btn-warning" onclick="window.location.href='<?php echo base_url();?>tu/edit_profil_usp/<?php echo hilang_karakter(base64_encode($r->id_profil));?>'">
