...
<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">Proposal Peminjaman</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li class="active"><span>Proposal Peminjaman</span></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="panel panel-default card-view">
			   ...
			   <div  class="panel-body">
												<h2>Proposal Pengajuan Pinjaman</h2>
                            ...
                            <span class="glyphicon glyphicon-plus" style="color:#ececec"></span> Tambah Proposal</button>
