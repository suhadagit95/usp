					...
					<div class="table-struct full-width full-height">
						<div class="table-cell vertical-align-middle auth-form-wrap">
							<div class="auth-form  ml-auto mr-auto no-float">
                               ...
                               foreach($ambil_profil_usp->result() as $pusp); 
                        ?>
														<img class="img-responsive" style="center" src="<?php echo base_url();?>/images/logo/<?php echo $pusp->logo;?>"  alt="USP" />
										...
										<div class="form-wrap">
											<form class="form-horizontal form-label-left" action="<?php echo base_url()."auth/login"; ?>" method="post" enctype="multipart/form-data">
												<div class="form-group">
                    <select name="cmbLevel" class="form-control" required="required">
                      ...
                      <div class="modal-content">
                          ...
                          <div class="modal-footer">
                              <button type="button" class="btn btn-default"
                                      onclick="window.location.href='<?php echo base_url()."auth/"; ?>'">
                                  KEMBALI
                              </button>
                          </div>
