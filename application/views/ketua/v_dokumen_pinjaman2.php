        ...
        <div class="col-md-8 col-sm-8 col-xs-12">
            <div class="panel panel-default card-view">
				...
				<ul class="nav navbar-left panel_toolbox">
                            ...
                            <button type="button" class="btn btn-sm btn-success" onclick="window.location.href='<?php echo base_url();?>ketua/pinjaman/<?php echo hilang_karakter(base64_encode($id_pemanfaat));?>'">
								...
								<div class="panel-wrapper collapse in">
									<div  class="panel-body row pa-0">
											...
											<div class="panel-body" style="text-align: center">
												...
												<button alt="default" data-toggle="modal" data-target=" class="btn btn-default btn-success">Diterima</button>
												<?php }?>
												<button alt="default" data-toggle="modal" data-target="" class="btn btn-default btn-danger">Tidak Diterima</button>
