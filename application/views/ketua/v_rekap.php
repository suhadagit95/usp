                ...
                <div class="x_content">
                    ...
                    <form id="demo-form2" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <select id="cmbTahun" name="cmbTahun" required="required" class="form-control col-md-7 col-xs-12">
                                    ...
                                    foreach ($ambil_tahun->result() as $t) {
                                        ?>
                                        <option value="<?php echo $t->tahun;?>" <?php if($tahun==$t->tahun) echo "Selected";?>><?php echo $t->tahun;?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <select id="cmbBulan" name="cmbBulan" required="required" class="form-control col-md-7 col-xs-12">
                                    <option value="">-Pilih Bulan-</option>
                                    <?php
                                    for($i=1; $i<=12; $i++) {
                                        ?>
                                        <option value="<?php echo $i;?>" <?php if($bulan==$i) echo "Selected";?>><?php echo bulanIndo($i);?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                ...
                if(isset($_POST['btnLihat'])) {
                    ...
                    <div class="x_title">
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            ?>
                            <a href="<?php echo base_url();?>ketua/cetak_rekap/<?php echo $encTahun."/".$encBulan;?>" target="_blank">
